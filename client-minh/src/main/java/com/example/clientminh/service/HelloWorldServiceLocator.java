...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements com.example.clientminh.service.HelloWorldService {
    ...
    public com.example.clientminh.service.HelloWorld getHelloWorldPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.example.clientminh.service.HelloWorld getHelloWorldPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.example.clientminh.service.HelloWorldPortBindingStub _stub = new com.example.clientminh.service.HelloWorldPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.example.clientminh.service.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                com.example.clientminh.service.HelloWorldPortBindingStub _stub = new com.example.clientminh.service.HelloWorldPortBindingStub(new java.net.URL(HelloWorldPort_address), this);
                _stub.setPortName(getHelloWorldPortWSDDServiceName());
                return _stub;
            }
        }
